 ...
 */
@Slf4j
@Component("SQLNumberExpr_CONVERT")
public class SQLNumberConvert implements DataTypeConvert<SQLNumericLiteralExpr> {
    @Override
    public void generatorColumnNameAndValue(@NotNull SQLIdentifierExpr sqlIdentifierExpr, @NotNull SQLNumericLiteralExpr sqlDataType, @NotNull LinkedHashMap<String, Object> linkedHashMap) {
        linkedHashMap.put(StringUtils.replace(sqlIdentifierExpr.getName(), "\"", ""), sqlDataType.getNumber());
    }
}
